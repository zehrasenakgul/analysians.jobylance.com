                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0 RightLinks">
                    <li class="nav-item active">
                        <a class="nav-link RightLink NavbarNotifications" href="#">
                            <img src="{{ asset('public/talha/assets/media/notificationbell.svg') }}" id="notificationbell" alt="">
                            <span class="CurrentSession_NotificationBadge">5</span>
                        </a>
                      </li>
                  <li class="nav-item active">
                    <span class="nav-link RightLink NavbarProfile" href="#">
                        <img src="{{ asset('public/talha/assets/media/navbarpp.svg') }}" class="CurrentSession_ProfilePicture" alt="">
                            ...
                            <div class="CurrentSession_HesapBilgilerim_ProfilePicture-Container">
                                <div class="dropdown">
                                    <button class="btn" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false">
                                        <img src="{{ asset('public/talha/assets/media/UploadImg.png') }}" alt="" class="UploadImage">
                                    </button>
                                    <div class="dropdown-menu" id="PhotoDropdownMenu" aria-labelledby="dropdownMenuButton">
                                        <div class="dropdown-item photo_upload_component">
                                            <label for="photo_upload" style="cursor: pointer;">Fotoğraf Yükle</label>
                                            <input type="file" name="photo_upload" style="visibility: hidden;" id="photo_upload" class="dropdown-item">
                                          </div>
    ...
    <div class="PageContent-Container">
        ...
        <div class="DashboardMenu">
            ...
            <div class="DashboardLinks">
                ...
                <a class="DashboardLink" href="./HesapBilgilerim.html" style="color: #9531c0">Hesap Bilgilerim</a>
            </div>
        </div>
        ...
        <div class="HesapBilgilerim-Container">
            ...
            <div class="ProfilePicture-Container">
                <img src="{{ asset('public/talha/assets/media/HesabimPP.png') }}" alt="" class="HesapBilgilerim_ProfilePicture">
            </div>
            <div class="HesapBilgilerim">
                <div class="InputRow">
                    <div class="LabelledInput">
                            <label for="">Kullanıcı Adı</label>
                            <input type="text" placeholder="" name="" id="" class="HesapBilgilerim_Username">
                        </div>
                        <div class="LabelledInput">
                            <label for="">Doğum Tarihi</label>
                            <input type="date" placeholder="" name="" id="" class="HesapBilgilerim_Birthday">
                        </div>
                </div>
                <div class="LabelledInput">
                    <label for="">Ad Soyad</label>
                    <input type="text" placeholder="" name="" id="" class="HesapBilgilerim_NameSurname">
                </div>
                <div class="LabelledInput">
                    <label for="">T.C No</label>
                    <input type="text" placeholder="" name="" id="" class="HesapBilgilerim_TCKN">
                </div>
                <div class="InputRowQuiplet">
                    <div class="InputRow">
                        <div class="LabelledInput">
                            <label for="">Email</label>
                            <input type="email" placeholder="" name="" id="" class="HesapBilgilerim_Email">
                        </div>
                        <div class="LabelledInput">
                            <label for="">Telefon Numarası</label>
                            <input type="text" placeholder="" name="" id="" class="HesapBilgilerim_TelNo">
                        </div>
                    </div>
                    <div class="InputRow">
                        <div class="LabelledInput">
                            <label for="">Ülke</label>
                            <input type="text" placeholder="" name="" id="" class="HesapBilgilerim_Country">
                        </div>
                        <div class="LabelledInput">
                            <label for="">İl/İlçe</label>
                            <input type="text" placeholder="" name="" id="" class="HesapBilgilerim_City/District">
                        </div>
                    </div>
                </div>
                <div class="LabelledInput">
                    <label for="">Adres</label>
                    <input type="text" placeholder="" name="" id="" class="HesapBilgilerim_Adress">
                </div>
                <div class="InputRow">
                    <div class="LabelledInput">
                        <label for="">IBAN</label>
                        <input type="text" placeholder="" name="" id="" class="HesapBilgilerim_IBAN">
                    </div>
                    <div class="LabelledInput">
                        <label for="">Hesap Sahibi</label>
                        <input type="text" placeholder="" name="" id="" class="HesapBilgilerim_AccountOwnerNameSurname">
                    </div>
                </div>
            </div>
        ...
        <div class="ProfileBio-Container">
            <div class="d-flex align-items-center profileinfo">
                <img src="{{ asset('public/talha/assets/media/PostOwnerPP.png') }}" alt="" class="ProfileBio_ProfilePicture">
                <div class="">
            ...
            <div class="ProfileBio">
                <span>Ben Kimim?</span>
                <p class="Biography">Lorem ipsum dolor sit, amet consectetur Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum ad nulla maxime maiores ea reprehenderit vel, voluptate laboriosam excepturi eaque nobis vero animi quidem assumenda praesentium incidunt reiciendis non optio voluptates. Excepturi molestias accusantium saepe. Reprehenderit quam, maxime vitae cupiditate labore, eius possimus id at officiis autem magnam maiores dicta! adipisicing elit. Alias quaerat, illum asperiores voluptas quas accusamus vel sint magni veniam. Sapiente molestiae enim laborum vitae possimus earum deleniti ducimus impedit aliquid, autem sunt. Ut asperiores iure numquam atque aliquid, illum repudiandae ex inventore molestias rerum voluptas deserunt explicabo aut beatae dolorum?</p>
            </div>
