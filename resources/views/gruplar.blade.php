            ...
            <div class="SideNavbar">
                <div class="CurrentSession_Account">
                    <img class="rounded-circle mr-2"
                        src="{{ Helper::getFile(config('path.avatar') . auth()->user()->avatar) }}" width="60"
                        height="60">
                    <div class="CurrentSession_Account_Textbox">
                        <h5>{{ auth()->user()->name }}</h5>
                        <a href="{{ url(auth()->user()->username) }}"><span class="CurrentSession_ProfiliGoruntule">Profili
                                Görüntüle</span></a>
                    </div>
                </div>
            ...
            -->
                        <div class="EditGroup_Container">
                            ...
                            <form action="" class="EditGroupForm">
                                <div class="EditGrouForm_Inputs LabelledInput" id="editGroupPhoto_div">
                                    <label for="EditProfilePictures">
                                        <div id="editGroupPhoto_btn">FOTOĞRAF YÜKLE</div>
                                    </label>
                                    <input type="file" name="EditProfilePictures" id="EditProfilePictures"
                                        style="visibility:hidden;">
                                    <img id="newGroupPhoto" src="{{ asset('public/talha/assets/media/GroupPicture.png') }}"
                                        alt="">
                                </div>
                        ...
                        <div class="Groups-Container">
                            <div class="Groups-Header">
                                <img id="GroupsHeaderimg" src="{{ asset('public/talha/assets/media/GruplarHead.svg') }}"
                                    alt="">
                                    ...
                                    <button type="submit">
                                        <div class="d-flex align-items-center" style="flex-direction: column;">
                                            <img src="{{ asset('public/talha/assets/media/ProfilePicture.svg') }}"
                                                alt="" class="Group_ProfilePicture">
                        ...
                        <div class="ChatBox">
                            <div class="Chatbox-Header">
                                <div class="ChatInfo-Container">
                                    <div class="d-flex align-items-center" style="gap:1em;">
                                        <img src="{{ asset('public/talha/assets/media/PostOwnerPP.png') }}"
                                            alt="" class="CurrentChat_Group_ProfilePicture">
                                ...
                                <div class="Messages_of_Date">
                                    <div class="Chat_Message-Container">
                                        ...
                                        <div class="Chat_Message_Content-Container">
                                            ...
                                            <div class="Chat_Message-Content">
                                                <img class="Chat_Message_Img" style="display: none;" src=""
                                                    alt="">
                                                <div class="Chat_Message_Text-Container">
                                                    <span class="Chat_Message_Text">Lorem Lorem ipsum dolor sit amet
                                                        consectetur adipisicing elit. Eligendi aperiam ea nobis, neque qui
                                                        blanditiis repudiandae, illum, provident officia a itaque. Excepturi
                                                        quis reiciendis autem! Itaque, consequatur. Ex eius itaque deserunt
                                                        omnis voluptatum asperiores maiores, sit enim rerum, provident totam
                                                        iste rem eos earum nemo error eligendi eum a accusantium. ipsum
                                                        dolor sit amet consectetur, adipisicing elit. Aut, delectus.</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="Chat_Message-Container">
                                        ...
                                        <div class="Chat_Message_Content-Container">
                                            ...
                                            <div class="Chat_Message-Content">
                                                <img class="Chat_Message_Img"
                                                    src="{{ asset('public/talha/assets/media/LiveStream.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="Chatbox_Inputs">
                                ...
                                <div class="SendMessage">
                                    <button type="submit" id="SendMessage"><i
                                    ...
                                    <div class="GroupInfo-Header UpperSide">
                                        <div class="Group_pp_Frame">
                                            <img src="{{ asset('public/talha/assets/media/GroupPicture.png') }}"
                                                alt="" class="GroupProfilePicture">
                                        </div>
                                        <div class="GroupTitle_Cont">
                                            <h4 class="GroupInfo_GroupName">Core Team</h4>
                                        </div>
                                        <span class="GroupInfo_CreatedBy">Created by Super Admin, <span
                                                class="GroupInfo_CreatedDate">01/01/01</span></span>
                                    </div>
                                    <div class="GroupInfo_Description_Section">
                                        <h6>Açıklama :</h6>
                                        <span class="GroupInfo_Description">Lorem ipsum, dolor sit amet consectetur
                                            adipisicing elit. Non cumque error veritatis rerum quisquam ipsa nesciunt
                                            exercitationem ratione reiciendis harum!</span>
                                    </div>
                                </div>
                            </div>
                            <div class="twoTabContainer">
                                <div class="twoTabContainer_Tabs">
                                    <div class="Tab activeTab" onclick="ChangeActivity(1)" id="UyelerTab_btn">
                                        <span>Üyeler</span></div>
                                    <div class="Tab" onclick="ChangeActivity(2)" id="Medyalar_btn">
                                        <span>Medyalar</span></div>
                                </div>
                                <div class="MembersTab memberstab_open">
                                    <div class="Member">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('public/talha/assets/media/ProfilePicture.svg') }}"
                                                style="width: 50px" alt="" class="MemberProfilePicture">
                                        ...
                                        <div class="btn-group">
                                            <button class="btn btn-sm member_options" type="button"
