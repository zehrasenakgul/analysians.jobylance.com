...
@section('content')
    <div class="layout-px-spacing">
        <div class=" layout-top-spacing">
            ...
            @endif
            <a href="parts/create"><button class="btn btn-light">Ekle</button></a>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <ul class="table-controls d-flex">
                                        <li><a href="{{ url('parts/' . $item->id) }}" data-toggle="tooltip"
                                        ...
                                        <li>
                                            <form
                                                action="{{ route('parts.destroy', ['part' => $item->id]) }}"method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
