                ...
                <div class="col-lg-5">
                                    ...
                                    @if ($settings->google_login == 'on')
                                        <a href="{{ url('oauth/google') }}"
                                            ...
                                            <img src="{{ url('public/img/google.svg') }}" class="mr-2" width="18"
                                                height="18"> {{ __('auth.sign_up_with') }} Google
                                        </a>
                                    @endif
                                </div>
                  ...
                  @endif --}}
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" value="{{ old('email') }}"
                                            placeholder="{{ trans('auth.email') }}" name="email" type="text" required>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary mt-4 w-100" id="btnLoginRegister"><i></i>
                                        {{ trans('auth.sign_up') }}</button>
                                </div>
                            </form>
